package menschaergerdichnicht.util.commonFunctions

import menschaergerdichnicht.model.{Cell, GameField, GameState, Token}
import menschaergerdichnicht.model.Player.{Blue, Green, Red, Yellow}
